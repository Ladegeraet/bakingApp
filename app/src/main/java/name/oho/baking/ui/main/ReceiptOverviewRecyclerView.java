...
public class ReceiptOverviewRecyclerView extends RecyclerView {
    ...
    public ReceiptOverviewRecyclerView(Context context) {
        super(context);
    }

    public ReceiptOverviewRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ReceiptOverviewRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
