...
import name.oho.baking.ui.receipt.dummy.DummyContent;
...
public class ReceiptListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.receipt_list);
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final ReceiptListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(ReceiptDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(ReceiptDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(ReceiptListActivity parent,
